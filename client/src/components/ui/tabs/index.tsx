...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn({
      'bg-slate-100 dark:bg-slate-800 inline-flex items-center justify-center rounded-md p-1': true,
      [className]: !!className,
    })}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    className={cn({
      'border-slate-200 dark:border-slate-700 mt-2 rounded-md border p-6': true,
      [className]: !!className,
    })}
    {...props}
    ref={ref}
