...
export const SoilHealthsChartTooltip = forwardRef<HTMLDivElement, TooltipProps<SoilHealthsData>>(
  ({ value, label }, ref) => {
...
SoilHealthsChartTooltip.displayName = 'SoilHealthsChartTooltip';
