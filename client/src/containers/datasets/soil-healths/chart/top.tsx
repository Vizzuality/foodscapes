...
interface SoilHealthsTopChartProps {
  selected?: readonly number[];
  onBarClick?: (key: number) => void;
}

const SoilHealthsTopChart = ({ onBarClick }: SoilHealthsTopChartProps) => {
  const filters = useRecoilValue(filtersSelector(null));

  // DATA
  const cQuery = useSoilHealths();
...
export default SoilHealthsTopChart;
