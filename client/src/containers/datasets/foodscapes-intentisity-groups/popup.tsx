...
interface FoodscapesIntensityGroupsPopupProps {
  latLng: LngLat;
}

const FoodscapesIntensityGroupsPopup = ({ latLng }: FoodscapesIntensityGroupsPopupProps) => {
...
export default FoodscapesIntensityGroupsPopup;
