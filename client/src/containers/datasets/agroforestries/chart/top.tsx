...
interface AgroforestriesTopChartProps {
  selected?: readonly number[];
  onBarClick?: (key: number) => void;
}

const AgroforestriesTopChart = ({ onBarClick }: AgroforestriesTopChartProps) => {
  const filters = useRecoilValue(filtersSelector(null));

  // DATA
  const cQuery = useAgroforestries();
...
export default AgroforestriesTopChart;
