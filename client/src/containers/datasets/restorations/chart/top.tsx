...
interface RestorationsTopChartProps {
  selected?: readonly number[];
  onBarClick?: (key: number) => void;
}

const RestorationsTopChart = ({ onBarClick }: RestorationsTopChartProps) => {
  const filters = useRecoilValue(filtersSelector(null));

  // DATA
  const cQuery = useRestorations();
...
export default RestorationsTopChart;
