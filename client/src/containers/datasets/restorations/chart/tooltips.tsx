...
export const RestorationsChartTooltip = forwardRef<HTMLDivElement, TooltipProps<RestorationsData>>(
  ({ value, label }, ref) => {
...
RestorationsChartTooltip.displayName = 'RestorationsChartTooltip';
